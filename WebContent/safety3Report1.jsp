...
"Mr Prashant Parmar 12:12:44",
	...
	[
		...
		var objectiveArray = [ "YES", "YES", "YES", "YES", "YES", "YES", "YES",
				"YES", "YES", "YES" ];
		var i, id, htmlData;
		function LoadData() {
			document.getElementById("text1").innerHTML = textone;
			document.getElementById("text2").innerHTML = texttwo;
			document.getElementById("text3").innerHTML = textthree;
