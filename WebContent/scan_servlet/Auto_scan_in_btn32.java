...
/**
 * Servlet implementation class Auto_scan_in_btn32
 */
@WebServlet("/Auto_scan_in_btn32")
public class Auto_scan_in_btn32 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("from scan_btn1_auto32 doget methode");
		user_info();
