...
import scan_Checklist.Managment_ScanThumb;
import scan_Checklist.Save_user_scan_detail;
import scan_Checklist.ScanThumb;

/**
 * Servlet implementation class Scan_btn1
 */
@WebServlet("/Scan_btn1")
public class Scan_btn1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
	String user_scan_Info = null, button_id = "1.1";
