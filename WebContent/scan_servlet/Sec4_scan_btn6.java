...
/**
 * Servlet implementation class Sec4_scan_btn6
 */
@WebServlet("/Sec4_scan_btn6")
public class Sec4_scan_btn6 extends HttpServlet {
	private static final long serialVersionUID = 1L;
	String user_scan_Info = null, button_id = "4.7";

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Sec4_scan_btn6() {
		super();
