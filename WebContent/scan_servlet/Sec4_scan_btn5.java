...
/**
 * Servlet implementation class Sec4_scan_btn5
 */
@WebServlet("/Sec4_scan_btn5")
public class Sec4_scan_btn5 extends HttpServlet {
	private static final long serialVersionUID = 1L;
	String user_scan_Info = null, button_id = "4.6";

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Sec4_scan_btn5() {
		super();
