...
import button_db.Store_sec4_scan_detail;
import jssc.SerialPortException;
import scan_Checklist.ScanThumb;

/**
 * Servlet implementation class Sec4_scan_btn1
 */
@WebServlet("/Sec4_scan_btn3")
public class Sec4_scan_btn3 extends HttpServlet {
	private static final long serialVersionUID = 1L;
	String user_scan_Info = null, button_id = "4.4";

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Sec4_scan_btn3() {
		super();
