...
/**
 * Servlet implementation class Sec4_scan_btn4
 */
@WebServlet("/Sec4_scan_btn4")
public class Sec4_scan_btn4 extends HttpServlet {
	private static final long serialVersionUID = 1L;
	String user_scan_Info = null, button_id = "4.5";

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Sec4_scan_btn4() {
		super();
