...
/**
 * Servlet implementation class Sec4_scan_btn7
 */
@WebServlet("/Sec4_scan_btn7")
public class Sec4_scan_btn7 extends HttpServlet {
	private static final long serialVersionUID = 1L;
	String user_scan_Info = null, button_id = "4.8";

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Sec4_scan_btn7() {
		super();
