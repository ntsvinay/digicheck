...
/**
 * Servlet implementation class Sec4_scan_btn
 */
@WebServlet("/Sec4_scan_btn")
public class Sec4_scan_btn extends HttpServlet {
	private static final long serialVersionUID = 1L;
	String user_scan_Info = null, button_id = "4.1"; 
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sec4_scan_btn() {
        super();
